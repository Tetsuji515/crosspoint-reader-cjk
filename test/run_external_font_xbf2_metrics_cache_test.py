...
TEST_FILE = REPO_ROOT / "test" / "ExternalFontXbf2MetricsCacheTest.cpp"
...
def main() -> int:
    with tempfile.TemporaryDirectory(prefix="xbf2-metrics-cache-test-") as temp_dir_str:
        temp_dir = Path(temp_dir_str)
        binary = temp_dir / "ExternalFontXbf2MetricsCacheTest"
