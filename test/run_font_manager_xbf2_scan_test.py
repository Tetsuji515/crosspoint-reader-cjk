...
TEST_FILE = REPO_ROOT / "test" / "FontManagerXbf2ScanTest.cpp"
FONT_MANAGER_CPP = REPO_ROOT / "lib" / "ExternalFont" / "FontManager.cpp"
...
def main() -> int:
    with tempfile.TemporaryDirectory(prefix="font-manager-xbf2-scan-") as temp_dir_str:
        temp_dir = Path(temp_dir_str)
        binary = temp_dir / "FontManagerXbf2ScanTest"
