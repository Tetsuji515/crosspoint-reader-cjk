...
TEST_FILE = REPO_ROOT / "test" / "ExternalAdvanceTest.cpp"
ADVANCE_CPP = REPO_ROOT / "lib" / "GfxRenderer" / "ExternalAdvance.cpp"
...
def main() -> int:
    with tempfile.TemporaryDirectory(prefix="external-advance-test-") as temp_dir_str:
        temp_dir = Path(temp_dir_str)
        binary = temp_dir / "ExternalAdvanceTest"
